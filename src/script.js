...
debugObject.portalColorStart = 0x759dff;
debugObject.portalColorEnd = 0x427cd2;
...
const portalLightMaterial = new THREE.ShaderMaterial({
  uniforms: {
    uTime: { value: 0 },
    uColorStart: { value: new THREE.Color(0x759dff) },
    uColorEnd: { value: new THREE.Color(0x427cd2) },
  },
